...
class Api_url:
    ...
    def get_forms_url(self):
        return {
            ...
            'get_mobile_form': {'url': self.dest_url + '/api/infosync/mobile_form/', 'method':'GET'},
    ...
    def get_users_url(self):
        return  {
            ...
            'get_user_catalog': {'url': self.dest_url + '/api/infosync/get_catalogs/', 'method':'GET'},
            'get_user_forms' :{'url': self.dest_url + '/api/infosync/user_admin/{0}/forms/?limit=0', 'method':'GET'},
            #'get_user_scripts': {'url': self.dest_url + '/api/infosync/user_admin/{0}/catalogs/?limit=0', 'method':'GET'},
