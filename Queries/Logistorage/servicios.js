...
month: {$month: "$created_at"},
    ...
    SAD_unit_price: {$last: "$5591627901a4de7bb8eb1ada.unit_price"},
    ...
    SAP_unit_price: {$last: "$559167ed01a4de7bba852992.unit_price"},
    ...
    SE_unit_price: {$last: "$5591627901a4de7bb8eb1adb.unit_price"},
    ...
    SEPONY_unit_price: {$last: "$5591627901a4de7bb8eb1adc.unit_price"},
    ...
    SAT_unit_price: {$last: "$559167ed01a4de7bba852993.unit_price"},
    ...
    SPY_unit_price: {$last: "$559167ed01a4de7bba852994.unit_price"},
    ...
    TCH_unit_price: {$last: "$5591627901a4de7bb8eb1add.unit_price"},
    ...
    TCOSTCO_unit_price: {$last: "$5591627901a4de7bb8eb1ade.unit_price"},
    ...
    STD_unit_price: {$last: "$55916a6f01a4de7bba852997.unit_price"},
    ...
    TNL_unit_price: {$last: "$5591627901a4de7bb8eb1adf.unit_price"},
    ...
    TERMO_unit_price: {$last: "$5591627901a4de7bb8eb1ae0.unit_price"},
    ...
    SD_unit_price: {$last: "$55916a6f01a4de7bba852998.unit_price"},
    ...
    RM_unit_price: {$last: "$55916a6f01a4de7bba852999.unit_price"},
    ...
    PALLET_IN_unit_price: {$last: "$55916a6f01a4de7bba85299a.unit_price"},
    ...
    PALLET_OUT_unit_price: {$last: "$55916a6f01a4de7bba85299b.unit_price"},
    ...
    KIT_PLAYERAS_unit_price: {$last: "$55916a6f01a4de7bba85299c.unit_price"},
    ...
    SERVICIO_REEMPACADO_unit_price: {$last: "$55916a6f01a4de7bba85299d.unit_price"},
    ...
    SERVICIO_REETIQUETADO_unit_price: {$last: "$55916a6f01a4de7bba85299e.unit_price"},
    ...
    SAEXH_unit_price: {$last: "$55916a6f01a4de7bba85299f.unit_price"},
    ...
    MI_unit_price: {$last: "$55916a6f01a4de7bba8529a0.unit_price"},
    ...
    TARIMA_NEGRA_MILLER_unit_price: {$last: "$5591627901a4de7bb8eb1ae1.unit_price"},
    ...
    MANO_OBRA_unit_price: {$last: "$5591627901a4de7bb8eb1ae2.unit_price"},
    ...
    PICK_AND_PACK_unit_price: {$last: "$55916a6f01a4de7bba8529a1.unit_price"},
    ...
    ENTRADA_DETALLE_unit_price: {$last: "$55916a6f01a4de7bba8529a2.unit_price"},
    ...
    FLEJE_VENTA_unit_price: {$last: "$55cb86f423d3fd09737bcc1a.unit_price"},
    ...
    PERSONAL_DEDICADO_PROYECTO_unit_price: {$last: "$55cb786023d3fd4818dd21b7.unit_price"},
    ...
    CROSS_DOCK_unit_price: {$last: "$55c5389623d3fd4818dd1dad.unit_price"},
    ...
    CROSS_DOCK_20_unit_price: {$last: "$55cb786023d3fd4818dd21b8.unit_price"},
    ...
    CROSS_DOCK_40_unit_price: {$last: "$55cb786023d3fd4818dd21b9.unit_price"},
    ...
    ALMACENAJE_TARIMA_unit_price: {$last: "$55cb786023d3fd4818dd21ba.unit_price"},
    ...
    TIEMPO_EXTRA_X_HORA_unit_price: {$last: "$55cb786023d3fd4818dd21bb.unit_price"},
    ...
    CROSS_DOCK_20_NOCTURNO_unit_price: {$last: "$55cb786023d3fd4818dd21bc.unit_price"},
    ...
    CROSS_DOCK_40_NOCTURNO_unit_price: {$last: "$55cb786023d3fd4818dd21bd.unit_price"},
    ...
    TIEMPO_EXTRA_X_HORA_NOCTURNO_unit_price: {$last: "$55cb786023d3fd4818dd21be.unit_price"},
    ...
    CROSS_DOCK_40_2_unit_price: {$last: "$55cb786023d3fd4818dd21bf.unit_price"},
    ...
    SAP_MAS_15_unit_price: {$last: "$55cb786023d3fd4818dd21c0.unit_price"},
    ...
    SAP_MENOS_15_unit_price: {$last: "$55cb786023d3fd4818dd21c1.unit_price"},
    ...
    SERVICIO_ARMADO_CARRETES_unit_price: {$last: "$55cb786023d3fd4818dd21c2.unit_price"},
    ...
    SERVICIO_ARMADO_CARRETES_URGENTES_unit_price: {$last: "$55cb786023d3fd4818dd21c3.unit_price"},
    ...
    UNIDAD_ESPACIO_TEMPORAL_unit_price: {$last: "$55cb7f5323d3fd032873662a.unit_price"},
    ...
    COSTO_MENSUAL_UE_unit_price: {$last: "$558db23301a4de7bba8528e5.unit_price"},
    ...
    COSTO_MENSUAL_UE_EXTRA_unit_price: {$last: "$55c5392c23d3fd4817ed01d0.unit_price"},
    ...
    PRECIO_TIEMPO_EXTRA_X_DIA_unit_price: {$last: "$5594677423d3fd7d311a4580.unit_price"},
    ...
    PRECIO_RENTA_FIJA_unit_price: {$last: "$5595a5ae23d3fd7d304980c3.unit_price"},
    ...
    PRECIO_RENTA_OFICINA_unit_price: {$last: "$5594688623d3fd7d311a4583.unit_price"},
    ...
    METROS_ACORDADOS_unit_price: {$last: "$5594688623d3fd7d311a4584.unit_price"},
