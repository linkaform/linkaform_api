...
def etl():
    ...
    for item in items_to_search:
		...
		**{
		    ...
		    'filters': ['TIenda:', 'Gerente de Tienda:', 
                                'Gerente de Distrito:', 'Empresa de Mantenimiento:', 
                                'Sistema de Control:', 'Fecha de Auditoria:', 'Auditoría realizada por:']
		    }
	    )
